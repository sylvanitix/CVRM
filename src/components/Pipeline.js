    ...
    >
      ...
      >
        <Typography 
          ...
          sx={{ 
            ...
            textShadow: '0 0 10px rgba(212, 255, 0, 0.4)',
          }}
        >
          Mon Parcours
        </Typography>
      ...
      <Box 
        sx={{ 
          ...
          '& > *': {
            flex: '1 1 0%',
            minWidth: 0, // Permet aux colonnes de rétrécir si nécessaire
          }
        }}
      >
      ...
      >
        {selectedCard && (
          <>
            ...
            >
              <Box sx={{ mb: 2 }}>
                <Typography variant="h5" sx={{ color: '#d4ff00', mb: 1 }}>
                  {selectedCard.title}
                </Typography>
                <Typography variant="subtitle1" sx={{ color: '#e5b3ff' }}>
              ...
              <Box sx={{ display: 'flex', gap: 2, mt: 2 }}>
                <Chip
                  icon={<PersonIcon />}
                  label={selectedCard.contact}
                  sx={{
                    bgcolor: 'rgba(212, 255, 0, 0.1)',
                    color: '#d4ff00',
                    '& .MuiChip-icon': { color: '#d4ff00' }
                  }}
                />
                <Chip
                  icon={<TimeIcon />}
                  label={new Date(selectedCard.deadline).toLocaleDateString()}
                  sx={{
                    bgcolor: 'rgba(229, 179, 255, 0.1)',
                    color: '#e5b3ff',
                    '& .MuiChip-icon': { color: '#e5b3ff' }
                  }}
                />
              </Box>
            </DialogContent>
      ...
      >
        <DialogTitle sx={{ bgcolor: '#2A1B3D', color: '#ffffff' }}>Ajouter un nouveau lead</DialogTitle>
        <DialogContent sx={{ bgcolor: '#2A1B3D', color: '#ffffff' }}>
        ...
        <DialogActions sx={{ bgcolor: '#2A1B3D', color: '#ffffff' }}>
      ...
      >
        {selectedCompany && (
          <>
            <DialogTitle sx={{ bgcolor: '#2A1B3D', color: '#ffffff' }}>
